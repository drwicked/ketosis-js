...
<html>
  <head>
    <title>${signal.statusCode} ${signal.statusMessage}</title>
  </head>
  <body>
    <div style="padding: 0 25px;">
      <h1 style="font-family: monaco, monospace, 'Lucida Console';font-weight:lighter;font-size: 18px;margin: 25px 0 10px 0;color: #BDBDBD;">
        ${signal.statusCode} ${signal.statusMessage}
      </h1>
      ${errorTemplate(signal, error)}
    </div>
  </body>
</html>`);
    } else {
